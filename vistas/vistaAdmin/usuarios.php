  ...
  <body>
    ...
    <div style="margin: auto; box-shadow: rgba(0,0,0,0.2) 0px 0px 20px 0px;" class="col-md-11 card shadow-inset">
        <div class="card-body col-md-12">
            <h2>Usuarios</h2>
            <button class="btn btn-primary float-right" data-toggle="modal" data-target="#Agregarusuario">Agregar Usuario</button>  
            <br>
            <br>
        ...
        <div class="form-group">
          ...
          <select name="rol" id="rol" class="form-control">
            ...
            <?php
              ...
              $result = mysqli_query($conexion, $rol);

              foreach ($result as $Rowrol) {
                
                echo '<option value= "'.$Rowrol['id'].'">'.$Rowrol['nombre'].'</option>';
...
<div class="modal fade" id="Editarusuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="../../modelos/editarusuario.php" method="POST">
      <div class="modal-body">
        ...
        <div class="form-group">
          <label>Contraseña</label>
          <input type="password" class="form-control" name="passwordUpdate" id="UpdatePass" placeholder="Ingrese Contraseña.">
        </div>
